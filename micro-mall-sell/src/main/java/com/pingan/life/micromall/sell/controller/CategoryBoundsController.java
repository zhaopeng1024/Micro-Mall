package com.pingan.life.micromall.sell.controller;
...
import com.pingan.life.micromall.sell.service.CategoryBoundsService;
 ...
 */
@RestController
@RequestMapping("sell/categorybounds")
public class CategoryBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sell:categorybounds:list")
    ...
    //@RequiresPermissions("sell:categorybounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("sell:categorybounds:save")
    ...
    //@RequiresPermissions("sell:categorybounds:update")
    ...
    //@RequiresPermissions("sell:categorybounds:delete")
